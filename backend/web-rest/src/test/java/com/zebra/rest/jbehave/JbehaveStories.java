package com.zebra.rest.jbehave;
...
/**
 * In order to run the Jbehave stories as junit in eclipse, first start the
 * server in the console in integration mode
 * 
 */
public class JbehaveStories extends JUnitStories {
	...
	public InjectableStepsFactory stepsFactory() {
		ApplicationContext context = new SpringApplicationContextFactory(
				"com/zebra/test/JbehaveConfigurationBeans.xml")
	...
	protected List<String> storyPaths() {
		return new StoryFinder().findPaths(
				codeLocationFromPath("src/test/resource"),
				"stories/**/*.story", "");
	}
